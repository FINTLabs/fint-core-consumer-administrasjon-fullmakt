...
public class FullmaktLinker extends FintLinker<FullmaktResource> {
    ...
    @Override
    public String getSelfHref(FullmaktResource resource) {
        return getAllSelfHrefs(resource).findFirst().orElse(null);
    }

    @Override
    public Stream<String> getAllSelfHrefs(FullmaktResource resource) {
    ...
    int[] hashCodes(FullmaktResource resource) {
